...
public function upload() {
    ...
    //         $filename = $data['upload_data']['file_name']; // Get the uploaded file's name
    ...
    //         // $data = $this->GoogleDriveModel->uploadFile($filename, $filepath, $mimetype);
    //         // print("<a href='https://drive.google.com/file/d/{$data}/view'>{$data}</a>");
    //         // unlink($filepath);
    //     }
    // }
    ...
    //     $filename = 'sample12345678.jpg';
    //     $filepath = FCPATH.'assets/sample12345678.jpg';
    //     $mimetype = 'image/jpeg';
